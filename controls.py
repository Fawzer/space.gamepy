...
def update(image, screen, stats, sc, gun, inos, bullents):
    """обновление экрана"""
    screen.blit(image, (0, 0))
    sc.show_score()
    for bullet in bullents.sprites():
        bullet.draw_bullet()
    gun.output()
    inos.draw(screen)
    pygame.display.flip()
